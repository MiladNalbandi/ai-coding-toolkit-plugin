...
- Tool-neutral practices reused across workflows: run a systematic debugging loop; force
  evidence (paste real test/lint/smoke output) before claiming done; run an adversarial AI
  code review; create the commit/PR at the end.
